 ...
 */
@WebServlet("/searchCourseNumber.do")
public class SearchNumberServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(courseListbyNumber.size() > 0){
			...
			for(int i = 0; i < courseListbyNumber.size(); i++){
				JSONObject course = new JSONObject(courseListbyNumber.get(i));
				String key = "course" + i;
